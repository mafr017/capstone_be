package com.madityafr.gatewayservice.filter;

import com.madityafr.gatewayservice.dto.UserDTO;
...
public class AppFilter implements GatewayFilter {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if (isApiSecured.test(request)) {
            ...
            response = restTemplate.exchange("http://localhost:8081/api/v1/auth/user-data-2", HttpMethod.GET, entity, UserDTO.class);
